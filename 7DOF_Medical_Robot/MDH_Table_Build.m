...
link(2) = struct('name','J1' , 'theta',   0, 'd', 153.7, 'a', 0, 'alpha',90 );       %1 TO 2  
link(3) = struct('name','J2' , 'theta',  0 , 'd', 0, 'a', 250.35, 'alpha',0 );    %2 TO 3  
link(4) = struct('name','J3' , 'theta',  0 , 'd', 0, 'a', 0, 'alpha',-90 );          %3 TO 4    
link(5) = struct('name','J4' , 'theta',  90 , 'd', 140, 'a', 0, 'alpha',-90 );          %4 TO 5 
link(6) = struct('name','J5' , 'theta',  0 , 'd', 84.8, 'a', 0, 'alpha',90 );          %5 TO 6
