...
Link(2) = struct('name','J1' , 'th',   0*ToRad, 'dz', 420, 'dx', 0, 'alf',-90*ToRad,'az',UZ);       %1 TO 2   320
Link(3) = struct('name','J2' , 'th',  -90*ToRad, 'dz', 0, 'dx', 200, 'alf',0*ToRad,'az',UZ);    %2 TO 3     200
Link(4) = struct('name','J3' , 'th',  0*ToRad, 'dz', 60, 'dx', 0, 'alf',-90*ToRad,'az',UZ);          %3 TO 4    25
Link(5) = struct('name','J4' , 'th',  0*ToRad, 'dz', 300, 'dx', 0, 'alf',90*ToRad,'az',UZ);          %4 TO 5    300
